    ...
    <div v-if="data" class="container">
        ...
        <header class="mb-10 md:mb-16">
          ...
          >
            ...
            <div class="flex items-center flex-wrap gap-2">
              <Tag
                v-for="(category, index) in data.item.meta.category"
                :key="index"
                class="capitalize"
              >
          ...
          <BCMSImage
            ...
            class="w-full aspect-[3.21] object-cover rounded-2xl md:rounded-3xl"
          />
        </header>
        <BCMSContentManager
      ...
      <div v-if="data.otherBlogs.length > 0" class="max-w-[1040px] mt-20">
        ...
        <div class="grid grid-cols-1 gap-12">
          <template v-for="(blog, index) in data.otherBlogs.slice(0, 2)">
            <BlogCard
              v-if="blog.meta.en"
              :key="index"
              :blog="blog.meta.en"
